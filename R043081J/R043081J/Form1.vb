...
Public Class Form1
    ...
    Public Sub LoadData()
        ...
        Dim bcaQuery As String = "SELECT COUNT(*) FROM students WHERE course = 'Bsc SE'"
        ...
        Dim mcaQuery As String = "SELECT COUNT(*) FROM students WHERE course = 'Bsc NE'"
        ...
        Dim iimcaQuery As String = "SELECT COUNT(*) FROM students WHERE course = 'Bsc HE'"
    ...
    Private Sub btnReport_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        If viewForm Is Nothing OrElse viewForm.IsDisposed Then
            viewForm = New ViewForm()
        End If
        viewForm.TopLevel = False
